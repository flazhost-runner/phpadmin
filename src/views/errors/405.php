...
<head>
    ...
    <style>
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        h1{font-size:5rem;font-weight:800;color:#F59E0B;line-height:1}
...
<div class="card">
    ...
    <p><?= htmlspecialchars($message ?? 'The HTTP method used is not allowed for this resource.', ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8') ?></p>
