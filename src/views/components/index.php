...
<div class="flex items-center justify-between mb-6">
  <div>
    ...
    <p class="text-sm text-gray-600">Acuan elemen siap-pakai. Lihat <code>docs/UI_COMPONENTS.md</code> untuk snippet copy-paste.</p>
  </div>
</div>
    ...
    <div class="stat-card bg-white rounded-xl shadow-lg p-6 hover-scale" style="border-left:4px solid var(--primary)">
      <div class="flex items-center justify-between">
        <div>
          ...
          <p class="text-3xl font-bold text-gray-800 counter" data-target="1280">0</p>
          <p class="text-green-500 text-sm mt-1"><i class="fas fa-arrow-up"></i> contoh tren</p>
        </div>
...
<section class="mb-10">
  ...
  <div class="alert alert-danger shadow-sm">Contoh pesan error.</div>
  <div class="alert alert-info shadow-sm">Contoh pesan info.</div>
  <div class="alert alert-warning shadow-sm">Contoh pesan peringatan.</div>
...
<section class="mb-10">
  ...
  <div class="tw-card p-6">
    <p class="text-sm text-gray-500 mb-4">
      Textarea dengan toolbar format + tombol <em>File Manager</em> untuk unggah/sisip gambar
      langsung ke OSS. Tambahkan class <code>trumbowyg-editor</code> pada textarea biasa
      (lihat <strong>nomor 7</strong>) untuk mengaktifkannya.
    </p>
    <div class="mb-2">
      <label class="form-label fw-semibold">Rich Text Editor + File Manager</label>
      <textarea class="trumbowyg-editor form-control"><p>Tulis konten <strong>kaya format</strong> di sini. Klik ikon gambar pada toolbar untuk membuka <em>File Manager</em>.</p></textarea>
    </div>
  </div>
</section>
...
<section class="mb-10">
  ...
  <div class="tw-card p-0 overflow-hidden">
    <div class="px-6 py-4 border-b flex items-center justify-between">
      <h3 class="text-lg font-bold" style="color:var(--primary)">List</h3>
